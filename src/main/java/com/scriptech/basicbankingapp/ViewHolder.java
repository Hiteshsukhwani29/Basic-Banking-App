...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView mName, mPhonenumber, mBalance, mRupee, mRupeeslash, mName1, mName2, mDate, mDesc;
    ImageView mPhone, mArrow,mImage;
    View mView;
    ...
    public ViewHolder(@NonNull View itemView) {
        ...
        mImage=itemView.findViewById(R.id.user_icon);
